        ...
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-lg-5 col-md-6">
                <div class="content pl-lg-3 pl-0">
                    <h2 id="what-is-the-main-mission-of-mine-and-what-i-wanna-do">What is the main mission of mine and
                        what i wanna do?</h2>
    ...
    <div class="container">
        <div class="row justify-content-around align-items-center">
            ...
            <div class="col-lg-4 col-md-6 text-center">
                ...
                <p class="mx-lg-3">Lorem ipsum dolor sit amet, sadipscing elitr, sed diam nonumy tempor invidunt labore
                    magna aliquyam</p>
            </div>
    ...
    <div class="container">
        <div class="row justify-content-center align-items-center">
            ...
            <div class="col-lg-5 col-md-6 text-center text-md-left">
                ...
                <a href="" class="btn btn-primary">Visit
                    Channel</a>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 col-md-8 mx-auto text-center">
                ...
                <p class="mb-4">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, diam nonumy eirmod tempor
                    labore dolore</p>
